...
@section('main')
    ...
    <div class="content">
        ...
        <div class="outer" style=" display: flex; flex-direction: column; align-items: center;">
            ...
            <form action="/buatHistory" method="POST" style="width: 90%;">
                @csrf
                ...
                <div class="batas" style="width: 100%;">
                    <div class="card" style="width: 40%; margin-left: -100px;">
                        ...
                        <div class="inCard" id="leftt">
                            <p class="stok">Isi Stok Awal:</p>
                            <p class="numberr">
                                <input type="number" name="stokAwal" id="" value="" style="width: 70px;">
                            </p>
                        </div>
                    </div>
                </div>
                <div style="display: flex; justify-content: center; width: 100%; margin-top: 20px;">
                    <button class="btn btn-success" type="submit">Simpan Stok Awal</button>
                </div>
            </form>
        </div>
    </div>
