...
<div id="accountDetails">
    ...
    <div id="contentWrapper">
        ...
        <button id="reviewButton">
            <img src="https://www.gstatic.com/images/icons/material/system_gm/2x/rate_review_gm_blue_18dp.png" alt="Gambar">
...
$back='kosong';
for($k=1;$k<=$rating;$k++){ if($back==='kosong' ){ $back='⭐️' ; } else{ $back .='⭐️' ; } } return $back; } @endphp