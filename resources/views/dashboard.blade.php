...
@section('main')
<div id="map"></div>
<div id="accountDetails" style=" position: absolute; z-index: 100; top: 0; right: 0; width: 25%; height: 100%; padding: 10px; border: 1px solid #ccc; display: none; background-color: #B83B5E;">
    ...
    <img src="path_to_image" alt="PKL Photo Goes Here" style="width: 100%; max-width: 100%; height: 230px; display: block; margin: 0 auto; border: #F9ED69 3px solid; border-radius: 5px">

    <div style="margin-top: 5px; text-align: center; display: flex; justify-content: space-around; width: 100%;">
        <button onclick="changeContent('Ulasan')" type="button" class="btn btn-success" style="flex: 1; border-radius: 0; color: #702c74; background-color: yellow;">Ulasan</button>
        <button onclick="changeContent('Menu')" type="button" class="btn btn-success" style="flex: 1; border-radius: 0; color: #702c74; background-color: yellow;">Menu</button>
        <button onclick="changeContent('Pesan')" type="button" class="btn btn-success" style="flex: 1; border-radius: 0; color: #702c74; background-color: yellow;">Pesan</button>
      </div>

      <div id="contentWrapper" style="border: yellow 3px solid; margin-top: 4px; width: 100%; height: 50%; border-radius: 5px">
...
<script>
    ...
    var marker = L.marker([51.5, -0.09]).addTo(map).on('click', function() {
    ...
    var marker = L.marker([51.5, -1.09]).addTo(map).on('click', function() {
        // Simulated account details (replace with actual session data)
        displayAccountDetails(); // Display account details when marker is clicked
    });;
